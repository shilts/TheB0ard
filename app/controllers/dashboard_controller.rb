...
class DashboardController < ApplicationController
	...
	def main
		swizzleURLHashArray = [
			...
			{:title => 'S5', :url => 'http://ltxl0207.sgdcelab.sabre.com/status', :link => 'http://ltxl0207.sgdcelab.sabre.com/login'},
			{:title => 'S5', :url => 'http://ltxl0207.sgdcelab.sabre.com/touch2/status', :link => 'http://ltxl0207.sgdcelab.sabre.com/tdot'}
